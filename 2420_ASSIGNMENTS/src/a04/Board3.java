...
public class Board3 {
	...
	public Iterable<Board3> neighbors() {
		...
		Queue<Board3> neighbors = new Queue<Board3>();
			...
			for(int j = 0; j < N;j++) {
				...
				if(this.twoDimenArray[i][j] == 0) {
					...
					if(j < N-1) {
						...
						Board3 newBoard = new Board3(this.twoDimenArray);
	...
	public static void main(String[] args) {
		...
		Board3 testBorad = new Board3(testArray2D);
		...
		for(Board3 e: testBorad.neighbors()) {
