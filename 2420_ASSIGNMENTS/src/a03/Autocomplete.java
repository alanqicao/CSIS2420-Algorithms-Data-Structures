...
public class Autocomplete {
	 ...
	 * 
	 * @param prefix the prefix string that we are searching for.
	...
	public Term[] allMatches(String prefix) {
		...
		int firstIndexOfMatched = BinarySearchDeluxe.firstIndexOf(terms, searchBasePrefix,
				Term.byPrefixOrder(prefix.length()));

		// search last index of the Terms array that match the search base,from a sorted array.
		int lastIndexOfMatched = BinarySearchDeluxe.lastIndexOf(terms, searchBasePrefix,
				Term.byPrefixOrder(prefix.length()));
