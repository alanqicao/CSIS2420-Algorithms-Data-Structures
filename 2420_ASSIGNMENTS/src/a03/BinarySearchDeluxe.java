...
public class BinarySearchDeluxe {
	...
	/**
	 * Uses a binary search algorithm to return the index of the first occurrence of
	 * the desired <code>key</code>.
	 * 
	 ...
	 * @param comparator The comparator used to compare the start, mid, and end
	 *                   values
	...
	/**
	 * Uses a binary search algorithm to return the index of the last occurrence of
	 * the desired <code>key</code>.
	 * 
	 * @param <Key>      The objects that the array is made of
	 * @param a          The array of Keys
